...
<head>
  ...
  <link rel="stylesheet" href="../../Pages/Componentes/Css/Regras3.css">
        ...
        <div class="card">
          <div class="box">
            <div class="content">
              ...
              <a href="NormasPublicacao.php">Saiba mais</a>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="box">
            <div class="content">
              ...
              <a href="Formato.php">Saiba mais</a>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="box">
            <div class="content">
              ...
              <a href="Estrutura.php">Saiba mais</a>
            </div>
          </div>
        </div>
      </section>
