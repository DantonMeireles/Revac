      ...
      <div class="container-profile">
        <div class="profile-header">
          <div class="profile-img">
            <img src="../../Componentes/Img/Ileck.jpg" width="200" alt="">
          </div>
          <div class="profile-nav-info">
            <h3 class="user-name">Matheus Henrique de Barros Ileck</h3>
            <div class="address">
              <p class="state">Avaliador </p>
            </div>
          </div>
          <div class="action">
          ...
          <div class="right-side">
            <div class="nav">
              <ul>
                ...
                <li onclick="tabs(1)" class="user-post">Artigos Publicados</li>
                <li onclick="tabs(2)" class="user-review">Artigos em Analíse</li>
              </ul>
            </div>
            <div class="profile-body">
              ...
              <div class="profile-posts tab">
                <?php $sql = $conn->query("SELECT * FROM ArtigosSubmetidos WHERE ds_status = 'EmAnalise'"); ?>
                <?php while ($dado = $sql->fetch(PDO::FETCH_ASSOC)) { ?>
                  <div class="div_center">
                    <ul class="Post-Caixas">
                      <li>
                        <span class="Post_Conteiner">
                          <h1>NOME DO ARTIGO: <?php echo $dado['nm_Artigo']; ?> </h1>
                          <h2>SUBÁREA: <?php echo $dado['nome_subarea']; ?></h2>
                          <h2>ÁREA:</h2>
                          <h2>STATUS: <?php echo $dado['ds_status']; ?></h2>
                          <h2>AUTOR(ES): <?php echo $dado['nm_autores']; ?></h2>
                          <h2>ORIENTADOR(ES): <?php echo $dado['nm_orientadores']; ?></h2>
                          <div class="Post_Rodape">
                            <?php
                            echo '<a class="btn btn-warning" href="../../../paginas testes para funcçoes/teste2.php?id=' . $dado['id_Artigo'] . '">Publicar</a> ';
                            ?>
                            <a class="btn btn-warning" href="<?php $dado['ds_caminho'] ?>">Recusar</a>
                            <a class="btn btn-warning" href="<?php $dado['ds_caminho'] ?>">Correção</a>
                            <a class="btn btn-warning" href="<?php $dado['ds_caminho'] ?>">Artigo</a>
                            <span class="Post_Data">Data de publicação: <strong>
                            <?php echo $dado['dt_submissão']; ?></strong></span>
                          </div>
                        </span>
                      </li>
                    </ul>
